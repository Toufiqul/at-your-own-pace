  ...
  return (
    <div className="mx-0">
      <motion.div
        ...
        className="relative h-screen w-screen flex items-center justify-center bg-cover bg-no-repeat mx-0"
        style={{ backgroundImage: `url(${backgroundImageUrl})` }}
      >
        <div className="relative text-white bg-opacity-40 p-6 rounded-lg w-full max-w-screen-xl flex items-center justify-between px-0">
          ...
          >
            <h2 className="text-xl mb-4">
              ACE satellite launched on a SpaceX Falcon 9 rocket at 1:33 A.M.,
              Feb 8th, 2024.
            </h2>
            <p>
